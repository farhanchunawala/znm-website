...
export default function AdminFeedbackPage() {
	...
	const getAverageRating = (feedback: Feedback) => {
		return (
			(feedback.fittingRating +
				feedback.fabricRating +
				feedback.serviceRating +
				feedback.deliveryPartnerRating) /
			4
		).toFixed(1);
	};
								...
								<div className={styles.feedbackHeader}>
									<div>
										...
										<p className={styles.customer}>
											{feedback.customerId?.firstName}{' '}
											{feedback.customerId?.lastName}
										</p>
