...
export default function ShipmentDetailPage({
	...
	const handleStatusChange = async (newStatus: string, data?: any) => {
		try {
			const res = await fetch(
				`/api/admin/shipments/${params.id}/status`,
				{
					method: 'PUT',
	...
	const handlePrintInvoice = async () => {
		...
		try {
			const res = await fetch(
				`/api/admin/orders/${shipment.orderId._id}/invoice`
			);
			...
			<div className={styles.header}>
				<div>
					...
					<p className={styles.subtitle}>
						Order:{' '}
						<Link href={`/admin/orders/${shipment.orderId._id}`}>
				...
				<div className={styles.section}>
					...
					<div className={styles.orderTotal}>
						...
						<span className={styles.totalAmount}>
							₹{shipment.orderId.total.toLocaleString()}
						</span>
					</div>
				</div>
				...
				<div className={styles.section}>
					...
					<div className={styles.infoGrid}>
						<div className={styles.infoItem}>
							...
							<Link
								href={`/admin/customers/${shipment.customerId._id}`}
				...
				<div className={styles.section}>
					...
					<div className={styles.infoGrid}>
						<div className={styles.infoItem}>
							...
							<span
								className={`${styles.badge} ${styles[shipment.orderId.paymentStatus]}`}
							>
