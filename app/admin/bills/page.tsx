...
export default function BillsPage() {
	...
	return (
        ...
        >
          ...
          <option value="billType">Sort by Type</option>
          <option value="amountToCollect">Sort by Amount</option>
        </select>
      ...
      {loading ? (
        ...
        <table className={styles.table}>
          ...
          <tbody>
            {bills.map((bill) => (
              <tr key={bill._id}>
                <td>{bill.orderSnapshot.orderNumber}</td>
                <td>{bill.customerSnapshot.name}</td>
                <td>
                  <span className={`${styles.badge} ${styles[bill.billType.toLowerCase()]}`}>
                    {bill.billType}
                  </span>
                </td>
                <td>
                  ₹{(bill.billType === 'COD' ? bill.amountToCollect : bill.amountPaid).toFixed(2)}
                </td>
                <td>
                  <span
                    className={`${styles.badge} ${
                      bill.status === 'active' ? styles.active : styles.cancelled
                    }`}
                  >
                    {bill.status}
                  </span>
                ...
                <td className={styles.actions}>
                  <button
                    onClick={() => getBillDetail(bill._id)}
        ...
        <div className={styles.modal}>
          <div className={styles.modalContent}>
            ...
            <div className={styles.detail}>
              <p>
                <strong>Order:</strong> {selectedBill.orderSnapshot.orderNumber}
              </p>
              <p>
                <strong>Customer:</strong> {selectedBill.customerSnapshot.name}
              </p>
              <p>
                <strong>Phone:</strong> {selectedBill.customerSnapshot.phone}
              </p>
              <p>
              ...
              <p>
                <strong>Print Count:</strong> {selectedBill.printCount}
              </p>
              <p>
