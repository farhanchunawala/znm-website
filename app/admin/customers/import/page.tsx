			...
			<div className={styles.form}>
				<div className={styles.instructions}>
					...
					<ul>
						...
						<li>
							<strong>phonecode</strong> - Country code (optional,
							defaults to +91)
						</li>
						<li>
							<strong>address</strong> - Street address (optional)
						</li>
						<li>
							<strong>city</strong> - City (optional)
						</li>
						<li>
							<strong>state</strong> - State (optional)
						</li>
						<li>
							<strong>country</strong> - Country (optional,
							defaults to India)
						</li>
						<li>
							<strong>zipcode</strong> - ZIP/Postal code
							(optional)
						</li>
					</ul>
					<p>
