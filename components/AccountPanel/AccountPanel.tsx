		...
		<>
			...
			<div className={styles.panel}>
				...
				<div className={styles.navigation}>
					...
					<button
						className={
							activeSection === 'offers' ? styles.active : ''
						}
					...
					<button
						className={
							activeSection === 'support' ? styles.active : ''
						}
							...
							<div className={styles.field}>
								...
								{editMode === 'birthdate' ? (
									<div className={styles.editField}>
										...
										<button
											onClick={() =>
												handleUpdateProfile('birthdate')
											}
											disabled={
												loading || !canChangeBirthdate()
											}
										>
											Save
										</button>
					...
					{activeSection === 'offers' && (
						<div className={styles.section}>
							...
							<div className={styles.newsletterSection}>
								<h4>NEWSLETTER</h4>
								<p>
									Stay updated with our latest offers and
									collections
								</p>
								<Link
									href="/newsletter"
					...
					{activeSection === 'support' && (
						<div className={styles.section}>
							...
							<div className={styles.supportOption}>
								<h4>Report a Bug</h4>
								<p>
									Found an issue? Let us know and we'll fix
									it.
								</p>
								<Link
									href="/contact-us?subject=bug"
									className={styles.link}
								>
									Report Bug →
								</Link>
